...
- [ ] Session 88d — 2026-08-10 — **Safe-area insets and a Firebase CDN guard, both verified. Native Google sign-in implemented but BLOCKED on GoogleService-Info.plist, and the plugin is uninstalled until that file exists.** Three fixes on `ios-capacitor-wrapper`; main untouched, Worker untouched, nothing merged.
