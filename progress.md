...
- **All templates restored**: both scheduling rows returned to their exact original wording and re-verified through the message endpoint; the other 8 were never edited and keep their original `updated_by`. Test scheduling rows deleted and the test client returned to `archived=1`.
